...
public static class BrandCatalog
{
    ...
    private static IReadOnlyList<Brand> Load()
    {
        ...
        using Stream? packed = assembly.GetManifestResourceStream("Alfred.UIKit.Suggest.brands.json.gz");
        ...
        using Stream? plain = assembly.GetManifestResourceStream("Alfred.UIKit.Suggest.brands.json");
