...
public sealed class CalendarViewModel : Observable
{
    ...
    public string MonthTitle => _month.ToString("MMMM yyyy", CultureInfo.InvariantCulture);

    public string SelectedTitle => _selected.ToString("dddd, d MMMM", CultureInfo.InvariantCulture);

    public bool DayIsEmpty => DayItems.Count == 0;

    public IReadOnlyList<string> WeekdayNames { get; } = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
